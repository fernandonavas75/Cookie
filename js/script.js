  ...
  const MORDIKA = {
    ...
    flavors: [
      ...
      { id: "redvelvet",      name: "Red Velvet",                        category: "principal", desc: "Cacao suave, color intenso",  img: "img/sabores/redvelvet.jpg" },
      { id: "chocolate",      name: "Chocolate",                         category: "principal", desc: "Cacao profundo, doble dosis", img: "img/sabores/chocolate.jpg" },
      { id: "lecheenpolvo",   name: "Leche en polvo",                    category: "principal", desc: "Dulce de infancia",           img: "img/sabores/lecheenpolvo.jpg" },
      { id: "mm",             name: "M&M",                               category: "principal", desc: "Coloridos chocolatines",      img: "img/sabores/mm.jpg" },
      { id: "chispas",        name: "Chispas de chocolate",              category: "principal", desc: "La favorita de siempre",      img: "img/sabores/chispas.jpg" },
      { id: "mermelada",      name: "Mermelada",                         category: "principal", desc: "Centro afrutado",             img: "img/sabores/mermelada.jpg" },
      { id: "nutella",        name: "Nutella",                           category: "principal", desc: "Avellana cremosa",            img: "img/sabores/nutella.jpg" },
      {id:"chocolate_vainilla", name: "Chocolate y Vainilla",              category: "principal", desc: "Combinación clásica",    img: "img/sabores/chocovainilla.jpg" },
      { id: "redvelvet_vainilla", name: "Red Velvet y Vainilla",             category: "principal", desc: "Mejor juntos que separados",   img: "img/sabores/rvvainilla.jpg" },
      { id: "chispasNutella", name: "Chispas de chocolate y Relleno de Nutella", category: "especial", desc: "Dulce y crocante a la vez", img: "img/sabores/chispasnutella.jpg" },
      {id: "chispascolores", name: "Chispas de colores",    category: "especial",  desc: "Dulce y divertido",           img: "img/sabores/chispascolores.jpg" },
      { id: "chispasblanco",  name: "Chispas de chocolate blanco",       category: "especial",  desc: "Dulce y delicada",            img: "img/sabores/chispasblanco.jpg" },
      { id: "redvelvetBetun", name: "Red Velvet y betún", category: "especial",  desc: "Contraste irresistible",      img: "img/sabores/rvbetun.jpg" },
      {id: "redvelvetchispas", name: "Red Velvet con chispas de chocolate ", category: "especial",  desc: "Intensidad máxima",           img: "img/sabores/rvchispas.jpg" },
      { id: "kinder",         name: "Kinder",                            category: "especial",  desc: "Chocolate de avellanas",      img: "img/sabores/kinder.jpg" },
      {id: "chispaschocolate", name: "Chispas de chocolate",    category: "especial",  desc: "Dulce y crocante",           img: "img/sabores/chispaschocolate.jpg" },
      {id: "fresa", name: "Galletas de fresa", category: "especial", desc: "Sabor frutal y dulce", img: "img/sabores/fresa.jpg" },
      {id: "BrownieCraquelada", name: "Brownie Craquelada", category: "premium", desc: "Textura única, sabor intenso", img: "img/sabores/brownie.jpg" },
      {id: "MonsterCookie", name: "Monster Cookie", category: "premium", desc: "Una bestia de sabores y texturas", img: "img/sabores/monster.jpg" },
      {id: "CokkieCream", name: "Cookie & Cream", category: "premium", desc: "Galleta de vainilla con chispas de chocolate y relleno cremoso", img: "img/sabores/cookiecream.jpg" },
      {id: "FresaOreo", name: "Fresas y Oreo", category: "premium", desc: "Galleta de fresa con trozos de Oreo y relleno cremoso", img: "img/sabores/fresaoreo.jpg" },
      {id: "DeOreo", name: "De Oreo", category: "premium", desc: "Galleta de chocolate con trozos de Oreo y relleno cremoso", img: "img/sabores/deoreo.jpg" },
      {id: "FrutRojo", name: "Frutos rojos", category: "premium", desc: "Galleta de vainilla con frutos rojos y relleno cremoso", img: "img/sabores/frutosrojos.jpg" },
      {id: "KitKat", name: "Kit Kat", category: "premium", desc: "Galleta de chocolate con trozos de Kit Kat y relleno cremoso", img: "img/sabores/kitkat.jpg" },
      {id: "dona", name: "Dona", category: "premium", desc: "Galleta en forma de dona", img: "img/sabores/dona.jpg" },
      {id: "crumblWaffle", name: "Crumbl Waffle", category: "premium", desc: "Galleta inspirada en los famosos waffles de Crumbl", img: "img/sabores/crumbl.jpg" },
      {id: "crumblCheeseCake", name: "Crumbl Cheesecake", category: "premium", desc: "Galleta inspirada en el cheesecake de Crumbl", img: "img/sabores/cheesecake.jpg" },
      {id: "cumblPieLimon", name: "Crumbl de Pie de Limón", category: "premium", desc: "Galleta inspirada en el pie de limón de Crumbl", img: "img/sabores/pielimon.jpg" },
      {id: "crumblPistachio", name: "Crumbl de Pistacho", category: "premium", desc: "Galleta inspirada en el sabor de pistacho de Crumbl", img: "img/sabores/pistacho.jpg" },
      {id: "crumblGomitas", name: "Crumbl de Gomitas", category: "premium", desc: "Galleta inspirada en el sabor de gomitas de Crumbl", img: "img/sabores/gomitas.jpg" },
      {id: "galletafresbetun", name: "Galleta de fresa y betún", category: "premium", desc: "Galleta de fresa con un delicioso betún de queso crema", img: "img/sabores/fresabetun.jpg" },
      {id: "caramelosalado", name: "Caramelo salado", category: "premium", desc: "Galleta de caramelo con un toque de sal", img: "img/sabores/caramelosalado.jpg" },
      {id: "galletacraqlimon", name: "Galleta craquelada de limón", category: "premium", desc: "Galleta de limón con una textura craquelada y un sabor refrescante", img: "img/sabores/craqlimon.jpg" },
      {id: "galletacraqchocolate", name: "Galleta craquelada de chocolate", category: "premium", desc: "Galleta de chocolate con una textura craquelada y un sabor intenso", img: "img/sabores/craqchocolate.jpg" },
      {id: "galletacraqredvelvet", name: "Galleta craquelada de red velvet", category: "premium", desc: "Galleta de red velvet con una textura craquelada y un sabor irresistible", img: "img/sabores/craqredvelvet.jpg" },
      {id: "galletacraqfresa", name: "Galleta craquelada de fresa", category: "premium", desc: "Galleta de fresa con una textura craquelada y un sabor refrescante", img: "img/sabores/craqfresa.jpg" },
      {id: "galletacraqvainilla", name: "Galleta craquelada de vainilla", category: "premium", desc: "Galleta de vainilla con una textura craquelada y un sabor clásico", img: "img/sabores/craqvainilla.jpg" },
      {id: "Reeses", name: "Reese's", category: "premium", desc: "Galleta de chocolate con trozos de Reese's y relleno cremoso de mantequilla de maní", img: "img/sabores/reeses.jpg" },
      {id: "brookie", name: "Brookie", category: "premium", desc: "Galleta que combina lo mejor de una brownie y una cookie", img: "img/sabores/brookie.jpg" },
